...
class CodeListingByFaculty extends StatefulWidget {
  String faculty;
  String facultLongName;
  List<Code> codes;
  List<Course> courses;
  CodeListingByFaculty({
    super.key,
  ...
  @override
  State<CodeListingByFaculty> createState() => _CourseListingByFacultyState();
}

class _CourseListingByFacultyState extends State<CodeListingByFaculty> {
  @override
